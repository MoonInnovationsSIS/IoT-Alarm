...
subscribetopic = "$aws/things/MyJet/shadow/name/myNamedShadow/update/accepted"
...
class SubHandler(client.SubscribeToTopicStreamHandler):
    ...
    def on_stream_event(self, event: SubscriptionResponseMessage) -> None:
        try:
            ...
            if jsonmsg['state']['desired']['alarm on']:
                print("true turn alarm on")
                GPIO.output(11,GPIO.HIGH)
            else:
                print("false turn off alarm")
